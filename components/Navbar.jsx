...
const Navbar = () => {
  return (
    <nav className="scrolled-header sticky top-0 left-0 w-full border-b border-[#4d4e53] shadow-sm text-xl bg-black z-10 mx-auto">
      <div className="px-12 h-24 flex justify-between items-center text-white relative" style={{ fontFamily: 'Univers, sans-serif' }}>
        <a href="#" className="md:inline hidden">Aidan Chang</a>
        <a href="#" className="md:hidden">AC</a>
