    ...
    return (
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                As a passionate learner who loves challenges, I am excited for the opportunities and lessons that I will go through in life. However anything goes, let&apos;s remember that we always will have a place in the stars!
                </p>
